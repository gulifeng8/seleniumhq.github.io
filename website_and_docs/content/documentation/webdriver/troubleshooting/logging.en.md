...
Get the root logger:
{{< gh-codeblock path="/examples/java/src/test/java/dev/selenium/troubleshooting/LoggingTest.java#L15" >}}
...
```
  {{% /tab %}}
  {{% tab header="Ruby" %}}
If you want to see as much debugging as possible in all of the classes,
...
{{< gh-codeblock path="/examples/ruby/spec/troubleshooting/logging_spec.rb#L8" >}}
  {{% /tab %}}
...
{{< gh-codeblock path="/examples/java/src/test/java/dev/selenium/troubleshooting/LoggingTest.java#L17-L18" >}}
  {{% /tab %}}
  {{% tab header="Python" %}}
...
To change the level of the logger:
{{< gh-codeblock path="/examples/ruby/spec/troubleshooting/logging_spec.rb#L10" >}}
  {{% /tab %}}
  {{% tab header="JavaScript" %}}
...
{{< gh-codeblock path="/examples/java/src/test/java/dev/selenium/troubleshooting/LoggingTest.java#L20-L21" >}}
  {{% /tab %}}
  {{% tab header="Python" %}}
...
basis:
{{< gh-codeblock path="/examples/java/src/test/java/dev/selenium/troubleshooting/LoggingTest.java#L23-L24" >}}
  {{% /tab %}}
  {{< tab header="Python" >}}
  {{< alert-content >}}{{< /alert-content >}}
  {{< /tab >}}
